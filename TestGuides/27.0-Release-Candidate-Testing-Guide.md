...
> ☝ The solvables wallet can update a PSBT with the UTXO, scripts, and pubkey for inputs
...
These steps only test a small fraction of the capabilities of Bitcoin Core wallet, so we
